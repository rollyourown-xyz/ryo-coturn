...
$IPT -A INPUT -p udp -m udp --dport 3478 -j ACCEPT
$IPT -A INPUT -p tcp -m tcp --dport 3478 -j ACCEPT
$IPT -A INPUT -p udp -m udp --dport 5349 -j ACCEPT
$IPT -A INPUT -p tcp -m tcp --dport 5349 -j ACCEPT

# Allow coturn UDP relay port range 50000-51000
$IPT -A INPUT -p udp -m udp --dport 50000:51000 -j ACCEPT
